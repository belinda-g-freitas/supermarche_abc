                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (value.length < 5) {
                            return AppLocalizations.of(context)!.minCaractersUsername;
                          }
                          return null;
                        },
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (value!.isEmpty) {
                            ...
                            return AppLocalizations.of(context)!.incorrectEntry;
                          }
                          return null;
                        },
                  ...
                  Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value!.length < 8) {
                              return AppLocalizations.of(context)!.minCaractersPassword;
                            }
                            return null;
                          },
                          obscureText: true,
                  ...
                  GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(AppLocalizations.of(context)!.registerButton.toUpperCase(),
